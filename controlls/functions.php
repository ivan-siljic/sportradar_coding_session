...
function event() 
{
	...
	$join[]  =	('JOIN team ON team.team_id = sport_event._fk_team_home');
	$join[] .=	('JOIN team t ON t.team_id = sport_event._fk_team_home');
	$join[] .=	('JOIN team f ON f.team_id = sport_event._fk_team_guest');
