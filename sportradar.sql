...
--
-- Host: localhost
-- Erstellungszeit: 22. Feb 2021 um 21:40
...
(6, 'Oberwart', 7400, 'Informstraße', 2, 1),
(7, 'Amstetten', 3300, 'Stadionstraße', 12, 1),
(8, 'Graz', 8010, 'Schönaugasse', 137, 1);
...
(14, 'Lisa', 'Schröfl', 'female', '1998-05-16', 3, 1),
...
(18, 'Lisa ', 'Zöhrer', 'female', '1998-11-23', 4, 1),
...
(25, 'David', 'Vötsch', 'male', '2001-10-01', 5, 1),
...
(37, 'José', 'Jardim', 'male', '1994-05-06', 8, 12),
...
(2, 2019, 20, 30, 20, 6, 1, 2, 2),
(3, 2019, 20, 18, 9, 8, 5, 3, 3),
(4, 2019, 20, 18, 5, 11, 7, 4, 3),
(5, 2019, 20, 17, 12, 5, 4, 5, 4),
(6, 2019, 20, 17, 12, 5, 3, 6, 4),
(7, 2019, 20, 14, 5, 9, 6, 7, 5),
(8, 2019, 20, 14, 9, 5, 3, 8, 5);
...
--
ALTER TABLE `sport_event`
  MODIFY `sport_event_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
